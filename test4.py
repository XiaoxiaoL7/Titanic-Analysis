...
sns.histplot(train[train['Survived']==1]['Age'], color ='blue', label ='Survived=1', kde=True, edgecolor='none')
sns.histplot(train[train['Survived']==0]['Age'], color ='red', label='Survived=0', kde=True)
plt.legend()
plt.show()